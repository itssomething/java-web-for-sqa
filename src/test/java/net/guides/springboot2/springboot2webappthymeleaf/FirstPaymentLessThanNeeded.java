...
@SpringBootTest
@Transactional
public class FirstPaymentLessThanNeeded {
...
//			System.out.println(user_id + ";;UI");
		...
		payment.setMoney_amount((double) 100000);
	}
	...
	public void test() {
		...
		assertFalse(payment_process_service.processPayment(loan, payment));
//		assertEquals(Double.valueOf(Math.ceil(new_loan_remaining_principal)), Double.valueOf(9158334));
	}
}
