...
@SpringBootTest
@Transactional
public class LendingSuccessTwo {
	@Autowired
	...
	public void setUp() {
		...
		user.setRole(1);
		user.setIncome((double)10000001);
		userRepo.save(user);
		...
		loan.setAmount_of_money((double) 300000000);
		loan.setNumber_of_period(12);
		loan.setLending_time(12);
		loan.setRemaining_principal((double) 300000000);
	...
	public void test() {
		...
		loan.setUser(user);
		assertTrue(loan_service.loanCreatable());
	}
}
