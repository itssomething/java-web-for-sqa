...
public class LendingFailTwo {
	...
	public void setUp() {
		...
		user.setRole(1);
		user.setIncome((double) (10*Math.pow(10,6))); 
		userRepo.save(user);
		...
		loan.setAmount_of_money((double) (30*Math.pow(10,7) + 1)); // 300 trieu 1 dong
		loan.setNumber_of_period(12);
		loan.setLending_time(12);
		loan.setRemaining_principal((double) (30*Math.pow(10,7) + 1)); // 300 trieu 1 dong
